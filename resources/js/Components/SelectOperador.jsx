...
export default function SelectOperador({operadores, setOperador, operador, tela}) {
    ...
    return(
        <select name="operador" onChange={(e) => setOperador({...operador, [tela.id]: e.target.value})} className="w-40 border border-black rounded-md bg-gray-100 px-3 me-1 my-2 py-1">

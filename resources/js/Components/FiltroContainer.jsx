...
export default function FiltroContainer({aplicaFiltros, filtros, telaId, campo, setCampo, operador, setOperador, valor1, setValor1, valor2, setValor2}) {
        ...
        <>
            {filtros && (
                <>
                    ...
                    <Button onClick={aplicaFiltros} variant="contained" sx={{fontSize: '11px', padding: '3px 10px', marginRight: '4px'}}>Consultar</Button>
